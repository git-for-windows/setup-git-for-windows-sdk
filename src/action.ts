...
import {mkdirp} from './downloader'
import process from 'process'
import {spawnSync} from 'child_process'
import {getArtifactMetadata, getViaGit, gitForWindowsUsrBinPath} from './git'
import {getViaCIArtifacts} from './ci_artifacts'
...
export async function run(core: ICore): Promise<void> {
